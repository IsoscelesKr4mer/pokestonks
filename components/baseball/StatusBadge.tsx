...
import { STATUS_META, PC_BADGE_CLASS, NEEDS_BACK_BADGE_CLASS } from './status';
...
export function PcBadge() {
  return <span className={`${PILL} ${PC_BADGE_CLASS}`} title="Personal collection. Not for sale.">PC</span>;
}
