...
(async()=>{
  ...
  const xml=`<?xml version="1.0" encoding="utf-8"?><GetItemRequest xmlns="urn:ebay:apis:eBLBaseComponents"><RequesterCredentials><eBayAuthToken>${tok}</eBayAuthToken></RequesterCredentials><ItemID>168645350740</ItemID><DetailLevel>ReturnAll</DetailLevel></GetItemRequest>`;
