...
async function main(){
  ...
  await sql`INSERT INTO purchases (user_id, catalog_item_id, purchase_date, quantity, cost_cents, source, notes)
    VALUES (${uid}, 17236, '2026-07-22', 1, 500, 'Vending Machine', 'Edmonds Safeway 4:28 - 1 DR pack')`;
  console.log(`Destined Rivals pack: held ${b} -> ${await held(17236)}`);
  appendFileSync('data/drop_log.csv',
    '2026-07-22,Wednesday,16:28,Edmonds Safeway,hit,Destined Rivals Booster Pack,1,5.00,bought on the :28 mark\n');
