...
const ORDER_ID = '03-14950-23180';
const SALE_DATE = '2026-07-24';
const FEES = 2300; // totalMarketplaceFee $23.00 (shipping is a wash; revenue = subtotal only)
const NOTES = `eBay order #${ORDER_ID}`;
// [lineRevenueCents, mapping[{catalogItemId c, qty q}]]
const LINES: [number, { c: number; q: number }[]][] = [
  [14999, [{ c: 31604, q: 2 }]], // WF-2PACK-R3 = 2x White Flare Booster Bundle
];
